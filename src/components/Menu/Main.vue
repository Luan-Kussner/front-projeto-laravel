<template>
  <nav class="bg-slate-900 flex flex-col items-center justify-between">
    ...
    <div class="flex-col items-center justify-center gap-2 my-10">
      <span class="text-xl text-white"> Luan Küssner </span>
      <div class="flex  justify-center gap-5">
        <a
          href="https://www.linkedin.com/in/luan-kussner/"
        ...
        ></a>
        <a
          href="https://github.com/Luan-Kussner"
          class="text-light fs-2"
          target="_blank"
        >
          <i
        ...
        <a
          href="https://github.com/Luan-Kussner/front-projeto-laravel"
          class="text-light fs-2"
          target="_blank"
        ...
        <a
          href="https://github.com/Luan-Kussner/ProjetoPHPLaravel"
          class="text-light fs-2"
          target="_blank"
